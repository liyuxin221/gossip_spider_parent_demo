 ...
 * @description:
 */
public class ManManBuy2 {
  public static void main(String[] args) throws Exception {
    // 1. 确定模拟登陆的url
    String loginUrl =
            "http://home.manmanbuy.com/login.aspx?tourl=http%3a%2f%2fhome.manmanbuy.com%2fusercenter.aspx";
    ...
    list.add(
            new BasicNameValuePair(
                    "__VIEWSTATE",
                    ""));
    list.add(
            new BasicNameValuePair(
                    "__EVENTVALIDATION",
                    "/wEWBQLWtMXXDwLB2tiHDgLKw6LdBQKWuuO2AgKC3IeGDLdh5P2IcOaCPXBowF3xw8rfEhx+"));
